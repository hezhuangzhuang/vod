...
/**
 * 第二个tab的第二层fragment_travel
 */
public class TravelTarentoFragment extends BaseFragment {
    ...
    public TravelTarentoFragment() {
    }

    public static TravelTarentoFragment newInstance() {
        TravelTarentoFragment fragment = new TravelTarentoFragment();
        return fragment;
    }
    ...
    protected void init() {
        for (int i = 0; i < titles.length - 1; i++) {
            fragments.add(TravelTarentoShareFragment.newInstance());
        }
        fragments.add(TravelTarentoForumFragment.newInstance());
