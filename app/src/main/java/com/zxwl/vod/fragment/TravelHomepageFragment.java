...
/**
 * 第二个tab的第二层fragment_homepage
 */
public class TravelHomepageFragment extends BaseFragment {
    ...
    public TravelHomepageFragment() {
    }

    public static TravelHomepageFragment newInstance() {
        TravelHomepageFragment fragment = new TravelHomepageFragment();
        return fragment;
    }
    ...
    protected void init() {
        ...
        for (int i = 0; i < titles.length; i++) {
            fragments.add(TravelHomePageCateFragment.newInstance());
        }
